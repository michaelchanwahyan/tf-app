...
# ref: https://github.com/christianversloot/machine-learning-articles/blob/main/how-to-build-a-resnet-from-scratch-with-tensorflow-2-and-keras.md
...
def training_process():
    ...
    trained_resnet.save('./trained_resnet.keras')  # The file needs to end with the .keras extension
